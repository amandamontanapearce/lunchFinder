...
function createMarkerArray(array) {
  ...
  for (var i = 0; i < arraylength; i++) {
    markerArray.push({
      id: array[i].id,
      coords: {latitude: array[i].geometry.location.lat, longitude: array[i].geometry.location.lng},
      options: {labelClass:'marker_labels',labelAnchor:'12 60',labelContent:array[i].name, fontFamily: 'Lato, sans-serif'},
      });
  }
  return markerArray;
}
